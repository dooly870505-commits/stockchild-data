(function () {
  ...
  /* Apps Script와 동일한 규칙: eventId를 문자열 오름차순 정렬한 목록에서의 위치 % 30 */
  ...
  /* 샤드 하나를 받아와서 캐시에 저장 (이미 받았으면 캐시 그대로 사용) */
  ...
  /* 카드 클릭 진입점: 뼈대 먼저 보여주고, 해당 종목이 속한 샤드 하나만 CDN에서 가져옴 */
